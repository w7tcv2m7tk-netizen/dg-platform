...
class DG_Module_Marketing {
    ...
    private function generate_audit_html($company, $data) {
        $icon_html = class_exists('DG_Brand') ? DG_Brand::email_icon_img(80, 'opacity:0.85;margin-bottom:12px;display:block;margin-left:auto;margin-right:auto;') : '';
        $header_lockup = class_exists('DG_Brand') ? DG_Brand::email_header_lockup(200, 40) : '';
