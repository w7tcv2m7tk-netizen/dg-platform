...
define('DG_PLATFORM_VERSION', '10.56.0');
...
require_once DG_INCLUDES_PATH . 'class-growth-engine-sync.php';
...
// Schema upgrade on any request (REST / portal) so deploy works without visiting wp-admin first.
